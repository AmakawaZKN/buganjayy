...
"thumbnailUrl": 'https://telegra.ph/file/aa7d0019dc63e0c47fa47.jpg', 
"thumbnail": kalimage
}}}
//=================================================//
const doc = { 
...
"fileName": `Zyじくあん${ngazap(prefix)}`,
"fileEncSha256": "ybdZlRjhY+aXtytT0G2HHN4iKWCFisG2W69AVPLg5yk="
}}}
//=================================================//
//=================================================//
const bal= (teks) => {
haikal.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": `Zyじくあん ${ngazap(prefix)}`,"body": `HW MODS WA ${ngazap(prefix)}`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": kalimage,"sourceUrl": `https://youtube.com/c/HwModsWa857`}}}, { quoted: doc })
} 
// Target
const reply = (teks) => {
return haikal.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": `Zyじくあん`,"body": `Selamat ${salam} kak ${pushname}`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": kalimage,"sourceUrl": `https://youtube.com/c/HwModsWa857`}}}, { quoted: hw })
} 

const anjay = (teks) => {
 haikal.sendMessage(m.chat, { image: kalimage, caption: teks, contextInfo:{"externalAdReply": {"title": `Zyじくあん`,"body": `Selamat ${salam} kak ${pushname}`,
previewType: "PHOTO",
showAdAttribution: true,
sourceUrl: `https://youtube.com/c/HwModsWa857`,
thumbnailUrl: 'https://telegra.ph/file/aa7d0019dc63e0c47fa47.jpg', 
...
gifPlayback:true,
jpegThumbnail:log0,
caption:`Haii 👋 Kak ${pushname} Selamat ${salam} *Aku Adalah Bot Zyじくあん*
...
"optionName": "KATANYA KEBAL"
	...
	{
"optionName": "SALAM BROTHER BY Zyじくあん"
	}
],
...
"contactMessage": {
"displayName": `© Zyじくあん${ngazap(prefix)}`,
...
"inviteExpiration": `MY NAME Zyじくあん${ngazap(prefix)}`,
"groupName": `MY NAME Zyじくあん${ngazap(prefix)}`,
...
"orderTitle": `© Zyじくあん${ngazap(prefix)}`,
"sellerJid": "6285714170944@s.whatsapp.net",
...
"retailerId": `© Zyじくあん WE ARE NOT MASTOD`,
...
user.afkReason = text
deploy(`${m.pushName} Hello Saya Bot Zyじくあん${text ? ': ' + text : ''}`)
}
break
//=================================================//
case 'bugstik':{
...
haikal.sendMessage(m.chat, { document: anuin, mimetype: 'application/octet-stream', fileName: `Zyじくあん ${ngazap(prefix)}.BIN`, title: `Zyじくあん ${ngazap(prefix)}.BIN` }, { quoted: doc })
}
break
//=================================================//
case 'bugtod': {
...
haikal.sendMessage(m.chat, anuala, `Zyじくあん${ngazap(prefix)}`, m)
}
}
break
case 'bugcrot' :
